...

{
    ...
    public async Task<IEnumerable<User>> GetAsync(SearhUserParametersDto seachParameters)
    {
        IQueryable<User> usersQuery = context.Users.AsQueryable();
        if (seachParameters.UsernameContains != null)
        {
            usersQuery =
                usersQuery.Where(u => u.UserName.ToLower().Contains(seachParameters.UsernameContains.ToLower()));
